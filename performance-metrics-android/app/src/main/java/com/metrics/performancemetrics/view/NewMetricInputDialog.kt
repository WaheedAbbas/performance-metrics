...
{
    private var metricEdtTxt  : EditText? = null
    ...
    fun showDialog(onAddNewMetric : OnAddNewMetric)
    {
        ...
        metricEdtTxt?.addTextChangedListener(metricNameTxtWatcher)
        ...
        addNewMetricBtn?.setOnClickListener {
            onAddNewMetric(metricEdtTxt?.text.toString())
            builder.dismiss()
        }

    }
    private var metricNameTxtWatcher: TextWatcher = object : TextWatcher {
